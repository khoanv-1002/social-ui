...
export const Header = () => (
    <header className="relative rounded-t-2xl bg-[url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTfjNpt7mV0bJ6BxvMN4D09lhUaiUcW8i5UwA&s)] bg-cover bg-center p-4 md:p-6 flex flex-col md:flex-row items-center gap-4 md:gap-6 text-white">
        <div className="absolute inset-0 bg-black/60 z-0" />
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-4 w-full">
            ...
            <div className="w-full md:w-auto">
                <div className="flex justify-center md:justify-start items-center mb-2">
                    ...
                    <button className="flex items-center border px-2 py-1 ml-3 border-zinc-600 text-white rounded-xl bg-gray-900 hover:bg-gray-700 transition-all">
